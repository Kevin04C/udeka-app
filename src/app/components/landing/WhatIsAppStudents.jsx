      ...
      <div className='what-is-app-student'>
        <div className='what-is-app-student__content'>
          <div className='what-is-app-student__texts'>
            <h3 className='heading'>¿QUÉ ES U DEKA?</h3>
            <p className='paragraph secondary'>
              U deka es una aplicación pensada en tí estudiante en la que podrás tener en un mismo
              lugar todas las herramientas que necesites para tus actividades académicas desde
